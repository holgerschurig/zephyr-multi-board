...
This ORG file is "somewhat" readable on Github. But, if you want to have a better presentation of the
articles therein, you should really visit it after Emacs, [[https://ox-hugo.scripter.co/][ox-hugo]] and [[https://gohugo.io/][Hugo]] processed it:
